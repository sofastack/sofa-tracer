...
/**
 * @author: guolei.sgl (guolei.sgl@antfin.com) 2019/11/29 3:38 PM
 * @since:
 **/
public class MessagePubStatReporter extends AbstractSofaTracerStatisticReporter {

    public MessagePubStatReporter(String statTracerName, String rollingPolicy,
    ...
    public void doReportStat(SofaTracerSpan sofaTracerSpan) {
        ...
        //method name
        statKey.setKey(buildString(new String[] { localApp }));
        //success
