...
/**
 * @author: guolei.sgl (guolei.sgl@antfin.com) 2019/9/1 7:59 PM
 * @since:
 **/
@ActiveProfiles("non-json")
public class NonJsonTest extends AbstractTestBase {
    ...
    private void testHttpClientPost(int expectedLength) throws Exception {
        ...
        // check type
        Assert.assertTrue(sofaTracer.getClientReporter() instanceof DiskReporterImpl);
        Reporter clientReporter = sofaTracer.getClientReporter();
        Assert
            .assertTrue(((DiskReporterImpl) clientReporter).getContextEncoder() instanceof HttpClientDigestEncoder);
