 ...
 */
package com.alipay.sofa.tracer.plugins.mongodb.repoters;
 ...
 * @since:
 **/
public class MongoStatReporter extends AbstractSofaTracerStatisticReporter {

    public MongoStatReporter(String statTracerName, String rollingPolicy, String logReserveConfig) {
    ...
    public void doReportStat(SofaTracerSpan sofaTracerSpan) {
        ...
        statKey.setKey(buildString(new String[] { localApp, methodName, dbType }));
        //success
