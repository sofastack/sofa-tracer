 ...
 * @since:
 **/
public class MongoStatJsonReporter extends AbstractSofaTracerStatisticReporter {

    public MongoStatJsonReporter(String statTracerName, String rollingPolicy,
    ...
    public void doReportStat(SofaTracerSpan sofaTracerSpan) {
        ...
        statKey.addKey(Tags.DB_TYPE.getKey(), tagsWithStr.get(Tags.DB_TYPE.getKey()));
