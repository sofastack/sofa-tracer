 ...
 * @since:
 **/
public class RocketMQSendStatJsonReporter extends AbstractSofaTracerStatisticReporter {

    public RocketMQSendStatJsonReporter(String statTracerName, String rollingPolicy,
