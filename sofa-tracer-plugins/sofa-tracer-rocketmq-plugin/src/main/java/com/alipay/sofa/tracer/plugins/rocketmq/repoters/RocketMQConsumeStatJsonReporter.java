 ...
 * @since:
 **/
public class RocketMQConsumeStatJsonReporter extends AbstractSofaTracerStatisticReporter {

    public RocketMQConsumeStatJsonReporter(String statTracerName, String rollingPolicy,
    ...
    public void doReportStat(SofaTracerSpan sofaTracerSpan) {
        ...
        statKey.addKey("consumerGroup", tagsWithStr.get("consumerGroup"));
