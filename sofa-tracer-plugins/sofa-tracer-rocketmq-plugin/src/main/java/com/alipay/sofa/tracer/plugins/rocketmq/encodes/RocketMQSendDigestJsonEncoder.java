 ...
 * @since:
 **/
public class RocketMQSendDigestJsonEncoder extends AbstractDigestSpanEncoder {
    ...
    protected void appendComponentSlot(XStringBuilder xsb, JsonStringBuilder jsb,
        ...
        jsb.append("msgType", tagWithStr.get("msgType"));
        jsb.append("bornHost", tagWithStr.get("bornHost"));
        jsb.append("brokerAddr", tagWithStr.get("brokerAddr"));
        jsb.append("producerGroup", tagWithStr.get("producerGroup"));
