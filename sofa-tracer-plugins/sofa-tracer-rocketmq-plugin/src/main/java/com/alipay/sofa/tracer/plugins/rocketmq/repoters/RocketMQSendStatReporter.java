 ...
 * @since:
 **/
public class RocketMQSendStatReporter extends AbstractSofaTracerStatisticReporter {

    public RocketMQSendStatReporter(String statTracerName, String rollingPolicy,
    ...
    public void doReportStat(SofaTracerSpan sofaTracerSpan) {
        ...
        //method name
        statKey.setKey(buildString(new String[] { localApp, operationName, topic }));
        //success
