...
import com.alipay.disruptor.util.Util;
...
abstract class RingBufferFields<E> extends RingBufferPad {
    ...
    protected final E elementAt(long sequence) {
        return (E) UNSAFE.getObject(entries, REF_ARRAY_BASE
 ...
 */
public final class RingBuffer<E> extends RingBufferFields<E> implements Cursored,
                                                            EventSequencer<E>, EventSink<E> {
     ...
     *
     * @param gatingSequences gatingSequences
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslator)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslator)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorOneArg, Object)
     * com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorOneArg, A)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorOneArg, Object)
     * com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorOneArg, A)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorTwoArg, Object, Object)
     * com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorTwoArg, A, B)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorTwoArg, Object, Object)
     * com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorTwoArg, A, B)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorThreeArg, Object, Object, Object)
     * com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorThreeArg, A, B, C)
     */
    @Override
    public <A, B, C> void publishEvent(EventTranslatorThreeArg<E, A, B, C> translator, A arg0,
                                       B arg1, C arg2) {
        final long sequence = sequencer.next();
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorThreeArg, Object, Object, Object)
     * com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorThreeArg, A, B, C)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvent(com.alipay.disruptor.EventTranslatorVararg, Object...)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvent(com.alipay.disruptor.EventTranslatorVararg, Object...)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslator[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslator[], int, int)
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslator[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslator[], int, int)
     */
    @Override
    public boolean tryPublishEvents(EventTranslator<E>[] translators, int batchStartsAt,
                                    int batchSize) {
        checkBounds(translators, batchStartsAt, batchSize);
        try {
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorOneArg, Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorOneArg, A[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorOneArg, int, int, Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorOneArg, int, int, A[])
     */
    @Override
    public <A> void publishEvents(EventTranslatorOneArg<E, A> translator, int batchStartsAt,
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorOneArg, Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorOneArg, A[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorOneArg, int, int, Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorOneArg, int, int, A[])
     */
    @Override
    public <A> boolean tryPublishEvents(EventTranslatorOneArg<E, A> translator, int batchStartsAt,
                                        int batchSize, A[] arg0) {
        checkBounds(arg0, batchStartsAt, batchSize);
        try {
            final long finalSequence = sequencer.tryNext(batchSize);
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorTwoArg, Object[], Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorTwoArg, A[], B[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorTwoArg, int, int, Object[], Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorTwoArg, int, int, A[], B[])
     */
    @Override
    public <A, B> void publishEvents(EventTranslatorTwoArg<E, A, B> translator, int batchStartsAt,
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorTwoArg, Object[], Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorTwoArg, A[], B[])
     */
    @Override
    public <A, B> boolean tryPublishEvents(EventTranslatorTwoArg<E, A, B> translator, A[] arg0,
                                           B[] arg1) {
        return tryPublishEvents(translator, 0, arg0.length, arg0, arg1);
    }

    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorTwoArg, int, int, Object[], Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorTwoArg, int, int, A[], B[])
     */
    @Override
    public <A, B> boolean tryPublishEvents(EventTranslatorTwoArg<E, A, B> translator,
        ...
        try {
            final long finalSequence = sequencer.tryNext(batchSize);
            translateAndPublishBatch(translator, arg0, arg1, batchStartsAt, batchSize,
                finalSequence);
            return true;
        } catch (InsufficientCapacityException e) {
            return false;
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorThreeArg, Object[], Object[], Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorThreeArg, A[], B[], C[])
     */
    @Override
    public <A, B, C> void publishEvents(EventTranslatorThreeArg<E, A, B, C> translator, A[] arg0,
                                        B[] arg1, C[] arg2) {
        publishEvents(translator, 0, arg0.length, arg0, arg1, arg2);
    }

    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorThreeArg, int, int, Object[], Object[], Object[])
     * com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorThreeArg, int, int, A[], B[], C[])
     */
    @Override
    public <A, B, C> void publishEvents(EventTranslatorThreeArg<E, A, B, C> translator,
        ...
        final long finalSequence = sequencer.next(batchSize);
        translateAndPublishBatch(translator, arg0, arg1, arg2, batchStartsAt, batchSize,
            finalSequence);
    }

    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorThreeArg, Object[], Object[], Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorThreeArg, A[], B[], C[])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorThreeArg, int, int, Object[], Object[], Object[])
     * com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorThreeArg, int, int, A[], B[], C[])
     */
    @Override
    public <A, B, C> boolean tryPublishEvents(EventTranslatorThreeArg<E, A, B, C> translator,
                                              int batchStartsAt, int batchSize, A[] arg0, B[] arg1,
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorVararg, Object[][])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#publishEvents(com.alipay.disruptor.EventTranslatorVararg, int, int, Object[][])
     */
    @Override
    public void publishEvents(EventTranslatorVararg<E> translator, int batchStartsAt,
                              int batchSize, Object[]... args) {
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorVararg, Object[][])
     */
    @Override
    ...
    /**
     * @see com.alipay.disruptor.EventSink#tryPublishEvents(com.alipay.disruptor.EventTranslatorVararg, int, int, Object[][])
     */
    @Override
    public boolean tryPublishEvents(EventTranslatorVararg<E> translator, int batchStartsAt,
                                    int batchSize, Object[]... args) {
    ...
    private void checkBounds(final EventTranslator<E>[] translators, final int batchStartsAt,
                             final int batchSize) {
    ...
    private <A, B> void checkBounds(final A[] arg0, final B[] arg1, final int batchStartsAt,
                                    final int batchSize) {
        checkBatchSizing(batchStartsAt, batchSize);
        batchOverRuns(arg0, batchStartsAt, batchSize);
    ...
    private <A, B, C> void checkBounds(final A[] arg0, final B[] arg1, final C[] arg2,
                                       final int batchStartsAt, final int batchSize) {
        checkBatchSizing(batchStartsAt, batchSize);
        batchOverRuns(arg0, batchStartsAt, batchSize);
        batchOverRuns(arg1, batchStartsAt, batchSize);
    ...
    private <A> void translateAndPublish(EventTranslatorOneArg<E, A> translator, long sequence,
                                         A arg0) {
        try {
    ...
    private <A, B, C> void translateAndPublish(EventTranslatorThreeArg<E, A, B, C> translator,
                                               long sequence, A arg0, B arg1, C arg2) {
        try {
    ...
    private void translateAndPublishBatch(final EventTranslator<E>[] translators,
                                          int batchStartsAt, final int batchSize,
    ...
    private <A> void translateAndPublishBatch(final EventTranslatorOneArg<E, A> translator,
                                              final A[] arg0, int batchStartsAt,
    ...
    private <A, B> void translateAndPublishBatch(final EventTranslatorTwoArg<E, A, B> translator,
                                                 final A[] arg0, final B[] arg1, int batchStartsAt,
    ...
    private void translateAndPublishBatch(final EventTranslatorVararg<E> translator,
                                          int batchStartsAt, final int batchSize,
                                          final long finalSequence, final Object[][] args) {
        final long initialSequence = finalSequence - (batchSize - 1);
        try {
            long sequence = initialSequence;
            final int batchEndsAt = batchStartsAt + batchSize;
