 ...
 */
public class SofaTracerObjDoubleConsumer<T> implements ObjDoubleConsumer<T> {
    private final FunctionalAsyncSupport functionalAsyncSupport;
    private final ObjDoubleConsumer<T>   wrappedObjDoubleConsumer;

    public SofaTracerObjDoubleConsumer(ObjDoubleConsumer<T> wrappedObjDoubleConsumer, SofaTracer tracer) {
