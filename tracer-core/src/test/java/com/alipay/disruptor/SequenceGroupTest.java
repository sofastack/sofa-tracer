...
import com.alipay.disruptor.support.TestEvent;
...
/**
 * @description: [test for SequenceGroup]
...
public class SequenceGroupTest {
    ...
    public void shouldAddWhileRunning() throws Exception {
        RingBuffer<TestEvent> ringBuffer = RingBuffer.createSingleProducer(TestEvent.EVENT_FACTORY,
            32);
        final Sequence sequenceThree = new Sequence(3L);
        final Sequence sequenceSeven = new Sequence(7L);
        final SequenceGroup sequenceGroup = new SequenceGroup();
