 ...
 */
package com.alipay.sofa.tracer.boot.springcloud.properties;
 ...
 * @since 2.0.0
 */
@ConfigurationProperties("com.alipay.sofa.tracer.springcloud.stream")
public class SofaTracerMessagingProperties {
